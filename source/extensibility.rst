...
Out of the box, Simple Injector only allows the creation of classes that contain a single public constructor. This behavior is chosen deliberately because `having multiple constructors is an anti-pattern <https://www.cuttingedge.it/blogs/steven/pivot/entry.php?id=97>`_.
...
The following article contains more information about changing the library's default behavior: `Primitive Dependencies with Simple Injector <https://www.cuttingedge.it/blogs/steven/pivot/entry.php?id=94>`_.
