...
While designing Simple Injector, we decided to **not** provide an XML based configuration API, since we want to push:

* :ref:`developers into best practices <Push-developers-into-best-practices>` and having a XML centered configuration is **not** best practice
